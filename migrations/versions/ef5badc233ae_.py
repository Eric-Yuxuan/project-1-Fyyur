...
Revision ID: ef5badc233ae
Revises: 591e1b5d1d71
Create Date: 2022-05-03 19:17:49.703214
...
revision = 'ef5badc233ae'
down_revision = '591e1b5d1d71'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['artist_id'], ['Artist.id'], name='show_info_artist_id_fkey'),
    sa.ForeignKeyConstraint(['venue_id'], ['Venue.id'], name='show_info_venue_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='show_info_pkey')
    )
    op.drop_table('show_infos')
