...
class Venue(db.Model):
  ...
  # upcoming_shows = db.Column(postgresql.ARRAY(Dictionary))
  # upcoming_shows = db.relationship("Artist", secondary="show_infos", backref=db.backref("venues"))
...
def show_venue(venue_id):
  ...
  for show in shows:
    if pytz.utc.localize(show.start_time) < pytz.utc.localize(datetime.utcnow()):
      ...
      # pass  Tuesday May, 21, 2019 at 9:30PM
    else:
      upcoming += 1
      artist = Artist.query.get(show.artist_id)
